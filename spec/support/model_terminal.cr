...
class ModelTerminal
  ...
  private def dispatch_private(parameters : String, final : Char) : Nil
    ...
    when "1000", "1002", "1003", "1004", "1006", "1049", "2004"
      # The alternate screen, bracketed paste, focus reporting and the mouse
      # tracking and encoding modes change nothing about what a cell holds,
      # which is all this model is for.
